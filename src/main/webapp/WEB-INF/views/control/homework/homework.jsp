...
<body>
<div class="container">
    <h2>发布作业<br/><small>你可以在这里发布选择题，阅读，完形填空和作文这些题型</small></h2>
    <hr/>
    <!--选择班级和小组-->
    <div class="row">
        <div class="col-md-4">
                <label for="homeworkClass">班级</label>
        ...
        <div class="col-md-4">
                <label for="homeworkGroup">小组</label>
                <select class="form-control form-homeworkGroup" id="homeworkGroup">
                    <option value="volvo">第一组</option>
                    <option value="saab">第二组</option>
                    <option value="fiat">第三组</option>
                </select>
        </div>
    </div>
    <!--导航栏-->
                ...
                <div class="chooseContent">
                    <form class="form-inline" id="choose1" name="choose1">
                        <div class="form-group">
                            <label>题目1</label>
                            <textarea type="text" class="form-control form-choosemain" name="chooseMain" placeholder="请输入题干">
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label>选项</label>
                            <textarea type="text" class="form-control form-choosemain" name="chooseSelect" placeholder="请输入选项">
                            </textarea>
                        </div>
            ...
            <div class="content">
                <div class="readingContent">
                    <form class="form-inline" name="reading1" id="reading1">
                        <div class="form-group">
                            <label>文章1</label>
                            <textarea type="text" class="form-control form-readingmain" name="readingMain" placeholder="请输入文章">
                            </textarea>
                        </div>
                        <hr/>
                        <div class="form-group">
                            <label>题目1</label>
                            <textarea type="text" class="form-control form-choosemain" name="readingChoose" placeholder="请输入题干">
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label>选项</label>
                            <textarea type="text" class="form-control form-choosemain" name="readingSelect" placeholder="请输入选项">
                            </textarea>
                        </div>
                        <button class="btn btn-primary" style="float: right">解析选项</button>
                        <div class="clearfix"></div>
            ...
            <div class="content">
                <div class="clozeContent">
                    <form class="form-inline" name="cloze1" id="cloze1">
                        <div class="form-group">
                            <label>文章1</label>
                            <textarea type="text" class="form-control form-readingmain" name="clozeMain" placeholder="请输入文章">
                            </textarea>
                        </div>
                        <hr/>
                        <div class="form-group">
                            <label>选项1</label>
                            <textarea type="text" class="form-control form-choosemain" name="clozeSelect" placeholder="请输入选项">
                            </textarea>
                        </div>
                        <button class="btn btn-primary" style="float: right">解析选项</button>
                        <div class="clearfix"></div>
