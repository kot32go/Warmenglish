...
public final class grade_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-md-3\">\n");
      out.write("\t\t\t\t\t<button class=\"btn btn-primary\" type=\"submit\" id=\"confirmGroup\"\n");
      out.write("\t\t\t\t\t\tstyle=\"margin-top: 30px\">查看</button>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t</div>\n");
      ...
      out.write("\t\t\t});\n");
      out.write("\t\t}\n");
      out.write("\t\tfunction sendMail(mail, date, selectGrade, essayGrade) {\n");
      out.write("\t\t\twho = prompt(\"Enter recipient's email address: \", mail);\n");
      out.write("\t\t\twhat = prompt(\"Enter the subject: \", \"您孩子在\"+date+\"测试的成绩单,选择题成绩：\"+selectGrade+\"分，作文：\"+essayGrade+\"分\");\n");
      out.write("\t\t\tif (confirm(\"Are you sure you want to mail \" + who\n");
      out.write("\t\t\t\t\t+ \" with the subject of \" + what + \"?\") == true) {\n");
      out.write("\t\t\t\tparent.location.href = 'mailto:' + who + '?subject=' + what\n");
      out.write("\t\t\t\t\t\t+ '';\n");
      out.write("\t\t\t}\n");
      out.write("\t\t}\n");
      out.write("\t</script>\n");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td></td>\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td><button\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"sendMail('");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${grade.student.adult_email}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write('\'');
          out.write(',');
          out.write('\'');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${grade.homework.date}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
          out.write('\'');
          out.write(',');
          out.write('\'');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${grade.selectGrade}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
